...
import defaultStorageData from '../../database_storage.json';
...
// with preloaded fallback if Firestore collection is initially syncing
export const INITIAL_HOTELS: Hotel[] = (defaultStorageData.hotels as unknown as Hotel[]) || [];
export const INITIAL_PACKAGES: UmrahPackage[] = (defaultStorageData.packages as unknown as UmrahPackage[]) || [];
export const INITIAL_DOCUMENTATION: DocumentationItem[] = (defaultStorageData.documentations as unknown as DocumentationItem[]) || [];
